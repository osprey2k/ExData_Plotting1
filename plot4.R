...
# plot (1,1)
plot(power_dat2$DateTime,power_dat2$Global_active_power,type="l",
     xlab="",
     ylab = "Global Active Power")

# plot (1,2)
plot(power_dat2$DateTime,power_dat2$Voltage,type="l",
     xlab="datetime",
     ylab = "Voltage")
...
# plot (2,2)
plot(power_dat2$DateTime,power_dat2$Global_reactive_power,type="l",
